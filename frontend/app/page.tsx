...
const content = {
  en: {
    ...
    heroTitlePrefix: "Natural language scheduling in ",
    heroTitleHighlight: "English & Indonesian",
    heroDescStart: "Just type — ",
  ...
  id: {
    ...
    heroTitlePrefix: "Jadwalkan dengan bahasa natural dalam ",
    heroTitleHighlight: "Bahasa Inggris & Indonesia",
    heroDescStart: "Ketik saja — ",
    heroDescCode: '"Meeting dengan tim besok jam 10 pagi"',
